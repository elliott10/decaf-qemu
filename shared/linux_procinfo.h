...
// int populate_mm_struct_offsets(CPUArchState *env, target_ptr mm, ProcInfo* pPI);
// int populate_vm_area_struct_offsets(CPUArchState *env, target_ptr vma, ProcInfo* pPI);
// int populate_dentry_struct_offsets(CPUArchState * env, target_ptr dentry, ProcInfo* pPI);
// int getDentryFromFile(CPUArchState * env, target_ptr file, ProcInfo* pPI);
...
// // or -1 if error
// int populate_kernel_offsets(CPUArchState *env, target_ptr threadinfo, ProcInfo* pPI);
